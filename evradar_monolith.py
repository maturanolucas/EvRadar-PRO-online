...
FORM_USE: int = _get_env_int("FORM_USE", 1)
FORM_LAST_N: int = _get_env_int("FORM_LAST_N", 5)
FORM_CACHE_HOURS: int = _get_env_int("FORM_CACHE_HOURS", 6)
FORM_K: float = _get_env_float("FORM_K", 0.30)  # intensidade do ajuste
FORM_MIN_MULT: float = _get_env_float("FORM_MIN_MULT", 0.85)  # piso do multiplicador
FORM_MAX_MULT: float = _get_env_float("FORM_MAX_MULT", 1.12)  # teto do multiplicador
...
DRAW_FAV_MIN_STRENGTH: int = _get_env_int("DRAW_FAV_MIN_STRENGTH", 3)
            ...
            try:
                ...
                if is_draw:
                    ...
                    allow_draw_fav = (
                        ...
                        and (context_boost_prob >= DRAW_MIN_CONTEXT_BOOST)
